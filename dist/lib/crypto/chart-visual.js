...
function createPriceLevelChart(currentPrice, levels, height = 20) {
    ...
    lines.push(chalk_1.default.gray('│') + chalk_1.default.bold.white(' PRICE LEVELS & SMC ZONES'.padEnd(chartWidth)) + chalk_1.default.gray('│'));
    lines.push(chalk_1.default.gray('├' + '─'.repeat(chartWidth) + '┤'));
...
function createTradeSetupVisual(currentPrice, entry, stopLoss, targets, bias) {
    ...
    lines.push(chalk_1.default.bold.white('  │') + chalk_1.default.bold.cyan('         TRADE SETUP VISUALIZATION          ') + chalk_1.default.bold.white('│'));
    lines.push(chalk_1.default.bold.white('  └─────────────────────────────────────────────┘'));
    lines.push('');
    if (bias === 'long') {
        // Long trade visualization
        targets.slice(0, 3).reverse().forEach((t, i) => {
...
function createMarketStructureVisual(smc) {
    ...
    lines.push('');
    lines.push(chalk_1.default.bold.white('  ┌─────────────────────────────────────────────┐'));
    lines.push(chalk_1.default.bold.white('  │') + chalk_1.default.bold.magenta('          MARKET STRUCTURE FLOW             ') + chalk_1.default.bold.white('│'));
    lines.push(chalk_1.default.bold.white('  └─────────────────────────────────────────────┘'));
    lines.push('');
    // Draw structure flow
...
function createOrderBlockVisual(orderBlocks, currentPrice) {
    ...
    lines.push('');
    lines.push(chalk_1.default.bold.white('  ┌─────────────────────────────────────────────┐'));
    lines.push(chalk_1.default.bold.white('  │') + chalk_1.default.bold.blue('             ORDER BLOCKS (OB)              ') + chalk_1.default.bold.white('│'));
    lines.push(chalk_1.default.bold.white('  └─────────────────────────────────────────────┘'));
    lines.push('');
    // Bullish OBs
...
function createFVGVisual(fvgs, currentPrice) {
    ...
    lines.push('');
    lines.push(chalk_1.default.bold.white('  ┌─────────────────────────────────────────────┐'));
    lines.push(chalk_1.default.bold.white('  │') + chalk_1.default.bold.yellow('          FAIR VALUE GAPS (FVG)             ') + chalk_1.default.bold.white('│'));
    lines.push(chalk_1.default.bold.white('  └─────────────────────────────────────────────┘'));
    lines.push('');
...
function createLiquidityVisual(liquidity, currentPrice) {
    ...
    lines.push('');
    lines.push(chalk_1.default.bold.white('  ┌─────────────────────────────────────────────┐'));
    lines.push(chalk_1.default.bold.white('  │') + chalk_1.default.bold.cyan('           LIQUIDITY POOLS                  ') + chalk_1.default.bold.white('│'));
    lines.push(chalk_1.default.bold.white('  └─────────────────────────────────────────────┘'));
    lines.push('');
